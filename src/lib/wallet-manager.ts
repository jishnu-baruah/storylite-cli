...
import { aeneid, mainnet, StoryClient, StoryConfig, PILFlavor } from '@story-protocol/core-sdk';
...
export class WalletManager {
    ...
    async encodeStoryTransaction(
        ...
        try {
            ...
            throw new Error(`Story SDK encoding failed: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
